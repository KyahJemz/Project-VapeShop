    ...
    public partial class AdminPage : Form
    {
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            if (index != "")
            {
                SqlConnection sqlcon = new SqlConnection(@"Data Source=DESKTOP-FAOH50K\SQLEXPRESS;Initial Catalog=vapeshop;Integrated Security=True");
                sqlcon.Open();
                SqlCommand cmd = new SqlCommand("delete from Accounts where Id = @index", sqlcon);
        ...
        private void btn_SaveChanges_Click(object sender, EventArgs e)
        {
            SqlConnection sqlcon = new SqlConnection(@"Data Source=DESKTOP-FAOH50K\SQLEXPRESS;Initial Catalog=vapeshop;Integrated Security=True");
            sqlcon.Open();
            SqlCommand cmd = new SqlCommand("Update Accounts set Username=@Username, Password=@Password where Id = '"+index+"'", sqlcon);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (index2 != "")
            {
                ...
                sqlcon.Open();
                SqlCommand cmd1 = new SqlCommand("delete from Carts where Transaction_Id = '" + index2 + "'", sqlcon);
        ...
        private void TransactionsTable_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            SqlConnection sqlcon = new SqlConnection(@"Data Source=DESKTOP-FAOH50K\SQLEXPRESS;Initial Catalog=vapeshop;Integrated Security=True");
            string query = "Select * from Carts join Items on Carts.Item_Id = Items.Id where Carts.Transaction_Id ='" + index2 + "'";
            SqlDataAdapter sda = new SqlDataAdapter(query, sqlcon);
