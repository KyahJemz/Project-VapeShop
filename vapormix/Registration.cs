    ...
    public partial class Registration : Form
    {
        ...
        private void btn_Register_Click(object sender, EventArgs e)
        {
            ...
            if (txt_Password1.Text.Trim() == txt_Password2.Text.Trim())
            {
                ...
                {
                    SqlConnection sqlcon2 = new SqlConnection(@"Data Source=DESKTOP-FAOH50K\SQLEXPRESS;Initial Catalog=vapeshop;Integrated Security=True");
                    sqlcon2.Open();
                    SqlCommand cmd = new SqlCommand("insert into Accounts values (@Username, @Password)", sqlcon2);
